export const dict = {
  ...
  "toast.update.description": "Nowa wersja OXESpace ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OXESpace",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OXESpace",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OXESpace na swoim urządzeniu",
  ...
  "settings.general.row.theme.description": "Dostosuj motyw OXESpace.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OXESpace",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OXESpace.",
