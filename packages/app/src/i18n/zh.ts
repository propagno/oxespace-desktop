...
export const dict = {
  ...
  "toast.update.description": "OXESpace 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OXESpace 团队",
  ...
  "settings.general.row.language.description": "更改 OXESpace 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 OXESpace 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OXESpace 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OXESpace 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OXESpace 启动时自动检查更新",
