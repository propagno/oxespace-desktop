...
export const dict = {
  ...
  "toast.update.description": "Eine neue Version von OXESpace ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OXESpace-Team",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OXESpace ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie OXESpace auf Ihrem Gerät aussieht",
  ...
  "settings.general.row.theme.description": "Das Thema von OXESpace anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OXESpace automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OXESpace.",
