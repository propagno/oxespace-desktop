export const dict = {
  ...
  "provider.custom.field.protocol.option.openai": "OpenAI compatible",
  "provider.custom.field.protocol.option.anthropic": "Anthropic compatible",
  "provider.custom.field.protocol.description": "Pick the wire format your gateway speaks. Anthropic compatible uses the /v1/messages request shape (x-api-key auth) instead of OpenAI chat completions.",
  ...
  "provider.custom.advanced.label": "Advanced",
  ...
  "settings.general.row.cavemanMode.title": "Caveman mode",
  "settings.general.row.cavemanMode.description": "Have the agent communicate in short, blunt, caveman-style language",
  "settings.general.row.githubTool.title": "GitHub tool",
  "settings.general.row.githubTool.description": "Let the agent manage pull requests, issues, and releases via the gh CLI",
  "settings.general.row.codegraph.title": "CodeGraph",
  "settings.general.row.codegraph.description": "Enable semantic code search and indexing via the CodeGraph MCP server. Run `codegraph init` in a project to build its index.",
