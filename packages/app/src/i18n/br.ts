export const dict = {
  ...
  "provider.custom.title.edit": "Editar provedor personalizado",
  "provider.custom.description.prefix": "Configure um gateway ou provedor self-hosted personalizado. Veja a ",
  ...
  "provider.custom.field.apiKey.description.edit": "Deixe em branco para manter a chave atual sem alterações.",
  "provider.custom.field.protocol.label": "Protocolo",
  "provider.custom.field.protocol.option.openai": "Compatível com OpenAI",
  "provider.custom.field.protocol.option.anthropic": "Compatível com Anthropic",
  "provider.custom.field.protocol.description": "Escolha o formato que seu gateway fala. Compatível com Anthropic usa o formato de requisição /v1/messages (autenticação x-api-key) em vez de chat completions da OpenAI.",
  "provider.custom.field.timeout.label": "Timeout (ms)",
  "provider.custom.field.timeout.placeholder": "600000",
  "provider.custom.field.timeout.description": "Opcional. Quanto tempo esperar por uma resposta antes de desistir, em milissegundos.",
  "provider.custom.advanced.label": "Avançado",
  ...
  "toast.update.description": "Uma nova versão do OXESpace ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OXESpace",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OXESpace",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o OXESpace aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OXESpace segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OXESpace é tematizado.",
  ...
  "settings.general.row.cavemanMode.title": "Modo cavernícola",
  "settings.general.row.cavemanMode.description": "Faz o agente se comunicar em frases curtas e diretas, estilo cavernícola",
  "settings.general.row.githubTool.title": "Ferramenta do GitHub",
  "settings.general.row.githubTool.description": "Deixa o agente gerenciar pull requests, issues e releases via o CLI `gh`",
  "settings.general.row.codegraph.title": "CodeGraph",
  "settings.general.row.codegraph.description": "Ativa busca semântica de código via o servidor MCP do CodeGraph. Rode `codegraph init` num projeto pra construir o índice dele.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OXESpace iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OXESpace.",
