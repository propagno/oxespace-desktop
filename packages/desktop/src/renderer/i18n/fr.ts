export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OXESpace a été téléchargée. Voulez-vous l'installer et redémarrer ?",
