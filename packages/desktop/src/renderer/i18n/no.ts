export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OXESpace er lastet ned. Vil du installere den og starte på nytt?",
