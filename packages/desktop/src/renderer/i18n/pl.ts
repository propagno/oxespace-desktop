export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OXESpace. Czy chcesz ją zainstalować i uruchomić ponownie?",
