export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OXESpace er blevet downloadet. Vil du installere den og genstarte?",
