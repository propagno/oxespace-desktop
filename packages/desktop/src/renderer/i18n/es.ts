export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OXESpace. ¿Quieres instalarla y reiniciar?",
