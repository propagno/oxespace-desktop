export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OXESpace wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
