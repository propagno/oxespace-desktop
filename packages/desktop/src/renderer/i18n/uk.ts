export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OXESpace",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OXESpace завантажено. Бажаєте встановити її та перезапустити?",
