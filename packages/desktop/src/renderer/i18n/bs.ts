export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OXESpace-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OXESpace-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
